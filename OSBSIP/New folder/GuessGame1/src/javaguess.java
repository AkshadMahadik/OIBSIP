 ...
 * @author Akshad
 */
public class javaguess extends javax.swing.JFrame {

    
    int random=0; String str2="";
            int life= 3;
    /**
     * Creates new form javaguess
     */
    public javaguess() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter Your Guessed Number");
        ...
        jLabel4.setText("1.Number is between 0 to 99");

        jLabel5.setText("2.There are 3 attempts ");
    ...
    for(int i=0;i<2;i++){
    if (a<=0 || a>100){
        Result.setText("Invalid Guess Try again");
     }
     else if(a==random){
        Result.setText("Congratulation Your Guess was Correct");
    }
    else if(a==random){
        Result.setText("Congratulation Your Guess was Correct");
    }
    else if(a<random){
        Result.setText("The Number You guess is Higher than Random Number");
        ...
        Result.setText("The Number You guess is Lower than Random Number "+str2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(javaguess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
